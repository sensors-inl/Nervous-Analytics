...
class SCRSegmenter(PostFilter):
    ...
    def __init__(self, filtered_eda_process_name, diff2_peak_threshold=0.01, min_elevation=0.2, replacing_margin=8,
                 onset_offset=+2, peak_offset=-2, min_onset_peak_ratio=1/4):
        """
    ...
    def _find_peaks_onsets(self, diff2):
        ...
        peaks = [idx for idx in range(1, len(diff2_thresh) - 1)
    ...
    def _is_onset(self, diff2, onset, real_peak):
        ...
        return (amplitude > diff2[onset - 1]
