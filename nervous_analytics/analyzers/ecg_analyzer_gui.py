...
class ECGAnalyzerGUI:
    ...
    def create_widgets(self):
        ...
        ttk.Button(self.control_frame, text="Browse...", command=self.browse_input_file).grid(row=0, column=2, padx=5, pady=5)
        ...
        ttk.Button(self.control_frame, text="Browse...", command=self.browse_output_file).grid(row=1, column=2, padx=5, pady=5)
        ...
        self.progress = ttk.Progressbar(self.status_frame, variable=self.progress_value, length=200, mode="determinate")
