...
class BinaryWeightedCrossentropy(losses.Loss):
    def __init__(self, weight_one=0.75, weight_zero=0.25, name='binary_weighted_crossentropy',
                 reduction=losses.Reduction.NONE, **kwargs):
        """
...
class BinaryBalancedCrossentropy(losses.Loss):
    ...
    def __init__(self, balance_ratio=0.75, name='binary_balanced_crossentropy',
                 reduction=losses.Reduction.NONE, **kwargs):
        """
